...
// ======================================================
//      🧊 CUBO 3D MAIS REALISTA: Face.prototype.draw
// ======================================================
Face.prototype.draw = function () {
	...
	// Ajusta a iluminação para ser menos "chapada"
	var baseLight = 0.6; // Luz ambiente mínima
	light = baseLight + (1 - baseLight) * light; 
	light = Math.max(0.4, Math.min(1.0, light)); // Garante que não seja preto total
	...
	// Adiciona um reflexo (brilho especular) sutil
	var gloss = ctx.createLinearGradient(this.p0.X, this.p0.Y, this.p2.X, this.p2.Y);
	...
	// Adiciona uma borda para definir o sticker
...
Face.prototype.getRenderData = function () {
	// ... (Esta função não é usada pela renderização principal, então a deixamos como está) ...
	this.normal.projection();
	var light = (
		false ?
			this.normal.y + this.normal.z * 0.5 :
...
function RubiksCube(canvas, width) {
    ...
    // Adiciona { alpha: true } para forçar a transparência
...
RubiksCube.prototype.render = function () {
	...
	// ======================================================
	//       🧊 CUBO 3D: FUNDO TRANSPARENTE
	// ======================================================
	// Em vez de preencher com uma cor, limpamos o canvas.
	// Isso deixa o fundo do card (#cube no CSS) visível.
